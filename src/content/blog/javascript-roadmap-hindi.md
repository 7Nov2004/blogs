...
* Spread & Rest Operators: `[...arr1, ...arr2]`
...
1. **Interactive To-Do List:** LocalStorage ke sath jisme page reload hone par bhi tasks delete na hon.
2. **Real-time Currency Converter / Calculator:** Live exchange rate API se calculate karne wala tool.
3. **Quiz Web App with Timer:** Multiple choice questions jisme score calculate ho aur sound effects aayein.
