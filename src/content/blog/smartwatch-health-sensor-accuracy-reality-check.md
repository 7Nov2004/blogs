...
featured: true
faqs:
  - question: "Kya Smartwatch SpO2 reading par medical diagnosis ke liye bharosa kar sakte hain?"
    answer: "Nahi, Smartwatch SpO2 sensors consumer wellness tracking ke liye hote hain. Medical emergencies (jaise severe asthma ya lung issues) mein hamesha FDA/CDSCO approved Fingertip Medical Pulse Oximeter ka hi use karein."
  - question: "Smartwatch wrist skin par Heart Rate kaise measure karti hai?"
    answer: "Smartwatch bottom par Green LED lights aur Photodiode sensors hote hain. Jab dil dhadakta hai toh wrist blood flow badhta hai jo green light ko absorb karta hai. Photodiode light reflection changes ko measure karke Heart Rate (BPM) calculate karta hai."
  - question: "Tattoos ya dark skin tone par PPG sensor error kyu deta hai?"
    answer: "Optical PPG sensors green light absorption par kaam karte hain. Deep skin melanin ya heavy wrist tattoos green light reflection ko block/scatter kar dete hain jisse PPG sensor reading inaccurate ho sakti hai."
---
...
```mermaid
flowchart TD
    A["Green LED Light Emitter"] -->|Light penetrates skin| B["Wrist Blood Vessels"]
    B -->|Pulse Beats Increase Blood Volume| C["Green Light Absorption Changes"]
    C -->|Reflected Light| D["Photodiode Receiver Sensor"]
    D -->|Algorithmic Processing| E["Heart Rate (BPM) Display"]
```
